  ...
  try {
    !function () {
                ...
                return e.base64
                  ...
                  : (function (e) {
                      ...
                      try {
                        ...
                        throw U(A.DATA_URL, 'Malformed data URL.');
                      }
                      return q(t);
                    })(e.rest);
              })(t),
      ...
      ((B = M = M || {})[(B.NO_ERROR = 0)] = 'NO_ERROR'),
        ...
        (B[(B.ABORT = 2)] = 'ABORT');
      var H =
        ((G.prototype.send = function (e, t, r, n) {
        ...
        (G.prototype.getResponseText = function () {
        ...
        (G.prototype.getResponseHeader = function (e) {
          return this.xhr_.getResponseHeader(e);
        }),
        (G.prototype.addUploadProgressListener = function (e) {
          null != this.xhr_.upload &&
            this.xhr_.upload.addEventListener('progress', e);
        }),
        (G.prototype.removeUploadProgressListener = function (e) {
          null != this.xhr_.upload &&
        ...
        (this.sent_ = !1),
          ...
          (this.sendPromise_ = new Promise(function (e) {
            t.xhr_.addEventListener('abort', function () {
              (t.errorCode_ = M.ABORT), e();
            }),
              t.xhr_.addEventListener('error', function () {
                (t.errorCode_ = M.NETWORK_ERROR), e();
              }),
      ...
      var W =
        ((X.prototype.createConnection = function () {
          return new H();
        }),
        X);
      function X() {}
      ...
      var Fe =
        ...
        (De.prototype._throwIfRoot = function (e) {
          if ('' === this._location.path) throw C(e);
        }),
        De);
      function De(e, t) {
        (this._service = e),
            ...
            switch (e.label) {
              case 0:
                return (
                  ...
                  (i = t.maxOperationRetryTime),
                  ((i = new we(o, 'GET', Oe(t, n), i)).errorHandler = xe(r)),
      ...
      var ct =
        ...
        (lt.prototype.updateMetadata = function (e) {
          return Ge(d(this._delegate), e);
        }),
        (lt.prototype.getDownloadURL = function () {
          return We(d(this._delegate));
        }),
        (lt.prototype.delete = function () {
          return this._throwIfRoot('delete'), Xe(d(this._delegate));
        }),
        (lt.prototype._throwIfRoot = function (e) {
          if ('' === this._delegate._location.path) throw C(e);
        }),
        lt);
      function lt(e, t) {
      ...
      function _t(e, t) {
        ...
        return new ht(n, new Je(n, t, e, new W(), r, o.default.SDK_VERSION));
      }
      (ft = o.default),
        (dt = {
          TaskState: D,
        ...
        ft.registerVersion('@firebase/storage', '0.5.5');
    }.apply(this, arguments);
  } catch (e) {
    throw (
      (console.error(e),
